...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function setThemeColor(color) {
        ...
        localStorage.setItem("selected-theme-color", color); // Save selected color
    }
    ...
    // Add click event to each theme color circle
    ...
    // Toggle theme switcher visibility on settings button click
...
document.addEventListener("DOMContentLoaded", () => {
    let bgMusic = new Audio("audio/bg__music.mp3"); // Replace with your music file
    bgMusic.loop = true; // Music will loop forever
    ...
    playMusic(); // Try autoplaying immediately

    // Ensure music starts after first user interaction (for autoplay-restricted browsers)
    document.addEventListener("click", () => {
        bgMusic.play();
    });

    // Prevent music from stopping if it gets paused accidentally
